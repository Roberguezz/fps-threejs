import { BoxGeometry, Color, Mesh, MeshStandardMaterial, Object3D, AmbientLight, DirectionalLight, Scene } from "three";
import type { ProjectileManager } from "../game/managers/ProjectileManager";
